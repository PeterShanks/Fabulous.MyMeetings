...
public static class Telemetry
{
    ...
    public static class Metrics
    {
        ...
        private static readonly Counter<long>
            ConsentGrantedCounter = Meter.CreateCounter<long>(Counters.ConsentGranted);
        ...
        private static readonly Counter<long> UserLoginFailureCounter =
            Meter.CreateCounter<long>(Counters.UserLoginFailure);
        ...
        public static void ConsentGranted(string clientId, IEnumerable<string> scopes, bool remember)
        {
            ...
            foreach (var scope in scopes)
                ConsentGrantedCounter.Add(1, new KeyValuePair<string, object>(Tags.Client, clientId),
        ...
        public static void ConsentDenied(string clientId, IEnumerable<string> scopes)
        {
            ArgumentNullException.ThrowIfNull(scopes);
            foreach (var scope in scopes)
                ConsentDeniedCounter.Add(1, new KeyValuePair<string, object>(Tags.Client, clientId),
                    new KeyValuePair<string, object>(Tags.Scope, scope));
        }
        ...
        {
            UserLoginFailureCounter.Add(1, new KeyValuePair<string, object>(Tags.Client, clientId),
                new KeyValuePair<string, object>(Tags.Idp, idp),
