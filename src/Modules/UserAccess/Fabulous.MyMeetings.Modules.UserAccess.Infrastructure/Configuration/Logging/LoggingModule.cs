...
namespace Fabulous.MyMeetings.Modules.UserAccess.Infrastructure.Configuration.Logging
{
    internal static class LoggingModule
    {
        public static void AddLogging(this IServiceCollection services, ILoggerFactory loggerFactory, IConfigureOptions<LoggerFilterOptions> logFilterOptions)
        {
            services.AddLogging();
