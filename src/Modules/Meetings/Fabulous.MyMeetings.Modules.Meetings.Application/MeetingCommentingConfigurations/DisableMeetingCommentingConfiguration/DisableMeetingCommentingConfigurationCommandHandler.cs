...
public class DisableMeetingCommentingConfigurationCommandHandler(
...
{
    public async Task Handle(DisableMeetingCommentingConfigurationCommand request, CancellationToken cancellationToken)
    {
        ...
        meetingCommentingConfiguration.DisableCommenting(memberContext.MemberId, meetingGroup);
    }
}