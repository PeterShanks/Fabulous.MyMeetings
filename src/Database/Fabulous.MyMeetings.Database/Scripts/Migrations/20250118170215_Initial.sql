...
PRINT N'Creating Schema [registrations]...';
GO
...
PRINT N'Creating Table [Registrations].[UserRegistrations]...';
GO
...
PRINT N'Creating Index [Registrations].[UserRegistrations].[IX_Registrations_UserRegistrations_ClusterKey]...';
GO

CREATE UNIQUE CLUSTERED INDEX [IX_Registrations_UserRegistrations_ClusterKey]
    ON [Registrations].[UserRegistrations]([ClusterKey] ASC);
GO

PRINT N'Creating Table [Registrations].[InboxMessages]...';
GO
...
PRINT N'Creating Index [Registrations].[InboxMessages].[IX_Registrations_InboxMessages_OccurredOn_ClusterKey]...';
GO

CREATE UNIQUE CLUSTERED INDEX [IX_Registrations_InboxMessages_OccurredOn_ClusterKey]
    ON [Registrations].[InboxMessages]([OccurredOn] ASC, [ClusterKey] ASC);
GO

PRINT N'Creating Index [Registrations].[InboxMessages].[IX_Registrations_InboxMessages_ProcessedDate]...';
GO

CREATE NONCLUSTERED INDEX [IX_Registrations_InboxMessages_ProcessedDate]
    ON [Registrations].[InboxMessages]([ProcessedDate] ASC) WHERE ProcessedDate IS NULL;
GO

PRINT N'Creating Table [Registrations].[OutboxMessages]...';
GO
...
PRINT N'Creating Index [Registrations].[OutboxMessages].[IX_Registrations_OutboxMessages_OccurredOn_ClusterKey]...';
GO

CREATE UNIQUE CLUSTERED INDEX [IX_Registrations_OutboxMessages_OccurredOn_ClusterKey]
    ON [Registrations].[OutboxMessages]([OccurredOn] ASC, [ClusterKey] ASC);
GO

PRINT N'Creating Index [Registrations].[OutboxMessages].[IX_Registrations_OutboxMessages_ProcessedDate]...';
GO

CREATE NONCLUSTERED INDEX [IX_Registrations_OutboxMessages_ProcessedDate]
    ON [Registrations].[OutboxMessages]([ProcessedDate] ASC) WHERE ProcessedDate IS NULL;
GO

PRINT N'Creating Table [Registrations].[InternalCommands]...';
GO
...
PRINT N'Creating Index [Registrations].[InternalCommands].[IX_Registrations_InternalCommands_EnqueueDate_ClusterKey]...';
GO

CREATE UNIQUE CLUSTERED INDEX [IX_Registrations_InternalCommands_EnqueueDate_ClusterKey]
    ON [Registrations].[InternalCommands]([EnqueueDate] ASC, [ClusterKey] ASC);
GO

PRINT N'Creating Index [Registrations].[InternalCommands].[IX_Registrations_InternalCommands_ProcessedDate]...';
GO

CREATE NONCLUSTERED INDEX [IX_Registrations_InternalCommands_ProcessedDate]
    ON [Registrations].[InternalCommands]([ProcessedDate] ASC) WHERE ProcessedDate IS NULL;
GO
...
PRINT N'Creating View [Registrations].[v_UserRegistrations]...';
GO
